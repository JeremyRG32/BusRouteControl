...
namespace BusRouteControl.Infrastructure.Migrations
{
    ...
    [Migration("20250313181059_AddArrivalTimeToSchedule")]
    partial class AddArrivalTimeToSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Routes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Schedules", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Tickets", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Schedules", b =>
                {
                    b.HasOne("BusRouteControl.Domain.Entities.Routes", "Route")
                        .WithMany("Schedules")
            ...
            modelBuilder.Entity("BusRouteControl.Domain.Entities.Tickets", b =>
                {
                    b.HasOne("BusRouteControl.Domain.Entities.Schedules", "Schedule")
                        .WithMany("Tickets")
                    ...
                    b.HasOne("BusRouteControl.Domain.Entities.Users", "User")
                        .WithMany("Tickets")
